...
// Called every frame
void APiezaRaraIzq::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);

}

void APiezaRaraIzq::SpawnBlocksIzq()
{
    ...
    for (auto&& YZ : YZs)
    {
        ...
        B->SetActorRelativeLocation(FVector(-20.0, YZ.first + -120, YZ.second + 20));
    }
}